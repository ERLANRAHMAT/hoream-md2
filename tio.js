...
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    apple = await getBuffer(`https://api.lannn.me/api/emoji/apple?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, apple, m, { packname: global.packname, author: global.author })
  break
case 'googleemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    google = await getBuffer(`https://api.lannn.me/api/emoji/google?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, google, m, { packname: global.packname, author: global.author })
  break
case 'samsungemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    lann = await getBuffer(`https://api.lannn.me/api/emoji/samsung?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, lann, m, { packname: global.packname, author: global.author })
  break
case 'microsoftemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    micro = await getBuffer(`https://api.lannn.me/api/emoji/microsoft?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, micro, m, { packname: global.packname, author: global.author })
  break
case 'whatsappemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    wa = await getBuffer(`https://api.lannn.me/api/emoji/whatsapp?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, wa, m, { packname: global.packname, author: global.author })
  break
case 'twitteremoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    twt = await getBuffer(`https://api.lannn.me/api/emoji/twitter?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, twt, m, { packname: global.packname, author: global.author })
  break
case 'facebookemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    fb = await getBuffer(`https://api.lannn.me/api/emoji/facebook?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, fb, m, { packname: global.packname, author: global.author })
  break
case 'skypeemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    sk = await getBuffer(`https://api.lannn.me/api/emoji/skype?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, sk, m, { packname: global.packname, author: global.author })
  break
case 'joyemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    joy = await getBuffer(`https://api.lannn.me/api/emoji/joypixels?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, joy, m, { packname: global.packname, author: global.author })
  break
case 'mojiemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    moji = await getBuffer(`https://api.lannn.me/api/emoji/openmoji?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, moji, m, { packname: global.packname, author: global.author })
  break
case 'pediaemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    pedo = await getBuffer(`https://api.lannn.me/api/emoji/emojipedia?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, pedo, m, { packname: global.packname, author: global.author })
  break
case 'lgemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    lg = await getBuffer(`https://api.lannn.me/api/emoji/lg?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, lg, m, { packname: global.packname, author: global.author })
  break
case 'htcemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    htc = await getBuffer(`https://api.lannn.me/api/emoji/htc?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, htc, m, { packname: global.packname, author: global.author })
  break
case 'mozillaemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    mozi = await getBuffer(`https://api.lannn.me/api/emoji/mozilla?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, mozi, m, { packname: global.packname, author: global.author })
  break
case 'softbankemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    soft = await getBuffer(`https://api.lannn.me/api/emoji/softbank?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, soft, m, { packname: global.packname, author: global.author })
  break
case 'docomoemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    doc = await getBuffer(`https://api.lannn.me/api/emoji/docomo?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
  tio.sendImageAsSticker(m.chat, doc, m, { packname: global.packname, author: global.author })
  break
case 'kddiemoji':
if (!text) return m.reply(`Masukkan Emoji\nExample: ${prefix+command} 🗿`)
  m.reply(mess.wait) 
    kddi = await getBuffer(`https://api.lannn.me/api/emoji/kddi?emoji=${encodeURIComponent(text)}&apikey=${lannkey}`)
...
break
   case 'attp': {
   if (!text) throw `Example : ${prefix + command} text`
   await tio.sendMedia(m.chat, `https://api.lannn.me/api/maker/attp?text=${text}&apikey=${lannkey}`, 'attp.webp', '', m, { asSticker: true })
 }
   break
   case 'ttp': {
   if (!text) throw `Example : ${prefix + command} text`
   await tio.sendMedia(m.chat, `https://api.lannn.me/api/maker/ttp?text=${text}&apikey=${lannkey}`, 'ttp.webp', '', m, { asSticker: true })
 }
 break
 case 'tts': {
 if (!text) throw `Example : ${prefix + command} text`
 let tts = await fetchJson(`http://api.lannn.me/api/sound/texttosound?text1=${text}&lang=id-ID&apikey=${lannkey}`)
...
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann = await getBuffer(`https://api.lannn.me/api/ephoto/ytgoldbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'ytsilver': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann2 = await getBuffer(`https://api.lannn.me/api/ephoto/ytsilverbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann2, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'iggold': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann1 = await getBuffer(`https://api.lannn.me/api/ephoto/iggoldbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann1, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'igsilver': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann3 = await getBuffer(`https://api.lannn.me/api/ephoto/igsilverbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann3, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'fbgold': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann12 = await getBuffer(`https://api.lannn.me/api/ephoto/fbgoldbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann12, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'fbsilver': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann31 = await getBuffer(`https://api.lannn.me/api/ephoto/fbsilverbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann31, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'twtgold': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann121 = await getBuffer(`https://api.lannn.me/api/ephoto/twtgoldbutton?text=${text}&apikey=${lannkey}`)
tio.sendMessage(m.chat, { image: lann121, caption: `Source Code https://api.lannn.me/ephoto` }, { quoted: fkontak })
break
case 'twtsilver': 
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let lann312 = await getBuffer(`https://api.lannn.me/api/ephoto/twtsilverbutton?text=${text}&apikey=${lannkey}`)
...
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let ephoto = await getBuffer(`https://api.lannn.me/api/ephoto/${command}?text=${text}&apikey=${lannkey}`)
...
if (!text) return m.reply(`Example : ${prefix + command} ${global.ownername}`) 
 m.reply(mess.wait)
let photooxy = await getBuffer(`https://api.lannn.me/api/photooxy/${command}?text1=${text}&apikey=${lannkey}`)
...
break
/*case 'cekapikey': case 'cekkey': {
          // if (!text) throw 'Mana Apikeynya?'
			if (!text) return m.reply('Mana Apikeynya?')
			let kukiw = `*Halo Kak ${pushname} Fitur Ini Dibuat Menggunakan Rest Api Dari Lolhuman,Zenz,Lann*`	
let sections = [
                {
	           title: 'Pilih Jenis Apinya ✨',
	           rows: [
	            {title: "Lolhuman 🍎", rowId: `ceklol ${text}`, description: `CEK APIKEY ZENZ ${text}`},
                {title: "Zenz 🌛", rowId: `cekzenz ${text} `, description: `CEK APIKEY LOLHUMAN ${text}`},
                {title: "Lann 💠", rowId: `ceklann ${text}`, description: `CEK APIKEY LANN ${text}`}               
	            ]
                }
                ]
                tio.sendListMsg(m.chat, kukiw, esce, `*${ucapanWaktu}*`, `CLICK FOR RESULT`, sections, m)
            ...
            break*/
case 'ceklann': case 'cekapikeylann': case 'ceklannkey': case 'cekapikey': 
if (!text) return m.reply(`Example : ${prefix + command} ${Lann}`) 
 m.reply(mess.wait)
let lannkey = await fetchJson(`https://api.lannn.me/api/checkkey?apikey=${text}`)
let apikey = `Cek Apikey From https://api.lannn.me\n🗝️Apikey = ${lannkey.result.apikey}\n💌Email = ${lannkey.result.email}\n👤Username = ${lannkey.result.username}\n💳Premium = ${lannkey.result.premium}\n📆Limit = ${lannkey.result.limit}\n⏳Expired = ${lannkey.result.expired}`
m.reply(apikey)
break
...
case 'ryujin':
case 'hijaber':
let cecan = await getBuffer(`https://api.lannn.me/api/cecan/${command}?apikey=${lannkey}`)
let buttonscecan = [{buttonId: `${command}`, buttonText: {displayText: 'Next Result 🔎'}, type: 1}]
tio.sendMessage(m.chat, { image: cecan, buttons: buttonscecan, caption: `Source Code https://api.lannn.me/cecan` }, { quoted: fkontak })
break  
//Primbon
...
case 'tiktok': case 'tt': case 'tiktoknowm': 
 if (!text) throw 'Masukkan Query Link!'
 anu = await fetchJson(`https://api.lannn.me/api/download/tiktok?url=${text}&apikey=${lannkey}`)
 tio.sendMessage(m.chat, { video: { url: anu.result.video }, fileName: 'tiktok.mp4', mimetype: 'video/mp4' }, { quoted: fkontak })
 break
case 'facebook': case 'fb': case 'fbdl': 
 if (!text) throw 'Masukkan Query Link!'
 anu = await fetchJson(`https://api.lannn.me/api/download/fbdown?url=${text}&apikey=${lannkey}`)
 tio.sendMessage(m.chat, { video: { url: anu.result.Normal_video }, fileName: 'facebook.mp4', mimetype: 'video/mp4' }, { quoted: fkontak })
 break
 case 'instagram': case 'ig': case 'igdl': 
 if (!text) throw 'Masukkan Query Link!'
 anu = await fetchJson(`https://api.lannn.me/api/download/igdowloader?url=${text}&apikey=${lannkey}`)
 ...
 if (!text) throw 'Masukkan Query Link!'
 anu = await fetchJson(`https://api.lannn.me/api/download/twitter?url=${text}&apikey=${lannkey}`)
 ...
 if (!text) throw 'Masukkan Query Link!'
let img = `https://api.lannn.me/api/tools/ssweb?device=desktop&url=${text}&apikey=${lannkey}`
...
case 'gempa' :
{
let gempa = await fetchJson(`https://api.lannn.me/api/webzone/gempa?apikey=${lannkey}`)
...
*Source Code :* https://api.lannn.me/api/webzone/gempa?apikey=${lannkey}`
...
case 'sange' :
m.reply(mess.wait)
  var data = await fetchJson(`https://api.lannn.me/api/webzone/cersex?apikey=${lannkey}`)
...
case 'allmenu': {          
            ...
            let ments = [ownernya, me, ini_kangbaned]
                anu = `*${ucapanWaktu}*\n*Kak @${me.split('@')[0]}*\n*Powered : @${ini_kangbaned.split('@')[0]}*\n`
                var { mgroup, mwebzone, mdownloader, msearch, mrandom, mtextpro, mcecan, mephoto, mphotooxy, mfun, mprimbon, mconvert, mmain, mdatabase, manonymous, mvoice, mowner  } = require('./fitur/menu.js')           
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'Donasi' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }]               
