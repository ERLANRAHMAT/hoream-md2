...
case 'allmenu': {          
            ...
            let ments = [ownernya, me, ini_kangbaned]
                anu = `*${ucapanWaktu}*\n*Kak @${me.split('@')[0]}*\n*Powered : @${ini_kangbaned.split('@')[0]}*\n`
                var { mgroup, mwebzone, mdownloader, msearch, mrandom, mtextpro, mephoto, mphotooxy, mfun, mprimbon, mconvert, mmain, mdatabase, manonymous, mvoice, mowner  } = require('./fitur/menu.js')           
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'Donasi' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }]               
