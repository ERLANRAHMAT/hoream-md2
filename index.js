...
tio.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: tekswell, footer: `Welcome Message By ${global.ownerName}`, buttons: but, mentions: [num], contextInfo: { externalAdReply: { showAdAttribution: true, title: global.packname, body: global.author, description: 'Made With ❤️ '+global.ownerName, mediaType: 2, thumbnail: global.thumb, mediaUrl: global.sosmed}} })
...
tio.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: teksbye, footer: `Leave Message By ${global.ownerName}`, buttons: but, mentions: [num], contextInfo: { externalAdReply: { showAdAttribution: true, title: global.packname, body: global.author, description: 'Made With ❤️ '+global.ownerName, mediaType: 2, thumbnail: global.thumb, mediaUrl: global.sosmed}} })
...
tio.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: tekspromote, footer: `Promote Message By ${global.ownerName}`, buttons: but })
...
tio.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: teksdemote, footer: `Demote Message By ${global.ownerName}`, buttons: but })
}
}
} else {
